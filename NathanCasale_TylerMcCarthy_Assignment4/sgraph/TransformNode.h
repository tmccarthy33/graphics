 ...
 */
  ...
  public:
    ...
    void parseForLights(GLScenegraphRenderer& context, stack<glm::mat4>& modelview,glm::mat4& camera_transform)
    {
        modelview.push(modelview.top());
        modelview.top() = modelview.top() *
                animation_transform *
        ...
        if(child!=NULL)
        {
            child->parseForLights(context,modelview,camera_transform);
        }
