 ...
 */
  ...
  public:
     ...
     */
    void parseForLights(stack<glm::mat4>& modelview,glm::mat4& camera_transform)
    {
        if((root!=NULL) && (renderer!=NULL))
        {
            renderer->parseForLights(root,modelview,camera_transform);
        }
    }
    ...
    void animate(float time, int animation, string object)
    {
          ...
          glm::mat4 ewok_elbow_transform = glm::mat4(1.0f);
          glm::mat4 ewok_wave_transform = glm::mat4(1.0f);
          ...
          case 2:
                  ...
                  break;
          case 3:
                    ewok_elbow_transform = ewok_elbow_transform *
                                            glm::translate(glm::mat4(1.0f),glm::vec3(-0.0f, -0.0f, 0.0f)) *
                                            glm::rotate(glm::mat4(1.0f),glm::radians(20*sin(time/50)),glm::vec3(0.0f,0.0f,1.0f)) *
                                            glm::rotate(glm::mat4(1.0f),glm::radians(-120.0f),glm::vec3(0.0f,0.0f,1.0f)) *
                                            glm::translate(glm::mat4(1.0f),glm::vec3(0.0f, 0.0f, 0.0f));
                    nodes[object+"righthand"]->setAnimationTransform(ewok_elbow_transform);
                    ewok_wave_transform = ewok_wave_transform *
                                            glm::translate(glm::mat4(1.0f),glm::vec3(0.0f, -0.0f, 0.0f)) *
                                            glm::rotate(glm::mat4(1.0f),glm::radians(20*sin(time/50)),glm::vec3(0.0f,0.0f,1.0f)) *
                                            glm::rotate(glm::mat4(1.0f),glm::radians(-20.0f),glm::vec3(0.0f,0.0f,1.0f)) *
                                            glm::translate(glm::mat4(1.0f),glm::vec3(0.0f, 0.0f, 0.0f));
                    nodes[object+"rightforearm"]->setAnimationTransform(ewok_wave_transform);
                break;
          default:
                  break;
          }
